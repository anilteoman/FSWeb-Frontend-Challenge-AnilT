...
const ProjectCards = () => {
  return (
    <div className='flex flex-col gap-10 w-full'> {/*ana container*/}
      <div className=' flex bg-white h-[380px] rounded-2xl shadow-2xl sm:flex-col sm:h-full'> {/*card1*/}
        <img src="/resimler/pizzachall.png" alt="proje1img" className='w-[450px] rounded-2xl pr-10 sm:w-full sm:pr-0'/>
        <div className='flex flex-col p-5 gap-10 my-auto'>
          <h2 className="text-[#3730a3] font-inter text-2xl font-bold sm:text-center">S8 Pizza Challenge</h2>
      ...
      <div className=' flex bg-white h-[380px] rounded-2xl shadow-2xl sm:flex-col sm:h-full'> {/*card1*/}
        <img src="/resimler/witflix.png" alt="proje1img" className='w-[450px] rounded-2xl pr-10 sm:w-full sm:pr-0'/>
        <div className='flex flex-col p-5 gap-10 my-auto'>
        <h2 className="text-[#3730a3] font-inter text-2xl font-bold sm:text-center">WitFlix</h2>
          <p className="font-inter">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore tempore vel unde eligendi neque porro, explicabo provident non est inventore modi illo dolor pariatur ipsa, cumque id temporibus necessitatibus in?</p>
          <div className='flex gap-2'> {/*techstack*/}
