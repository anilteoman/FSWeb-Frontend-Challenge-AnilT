    ...
    <div className='flex flex-col gap-10 w-full'> {/*ana container*/}
      <div className=' flex bg-white h-full rounded-2xl shadow-2xl flex-col sm:flex-row sm:h-[380px] dark:bg-[#3A3A3A]'> {/*card1*/}
        ...
        <div className='flex flex-col p-5 gap-10 my-auto'>
          ...
          <p className="font-inter dark:text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore tempore vel unde eligendi neque porro, explicabo provident non est inventore modi illo dolor pariatur ipsa, cumque id temporibus necessitatibus in?</p>
          ...
          <div className='flex gap-10'>
            <a className="font-inter underline font-bold dark:text-[#CBF281]" href="#">View Project</a><a className="font-inter underline font-bold dark:text-[#CBF281]" href="https://github.com/anilteoman/fsweb-s8-challenge-pizza">Github</a>
      ...
      <div className=' flex bg-white h-full rounded-2xl shadow-2xl flex-col sm:flex-row sm:h-[380px] dark:bg-[#3A3A3A]'> {/*card2*/}
        ...
        <h2 className="text-[#4832D3] font-inter text-2xl font-bold text-center sm:text-left dark:text-[#BAB2E7]">WitFlix</h2>
          ...
          <div className='flex gap-10'>
            <a className="font-inter underline font-bold dark:text-[#CBF281]" href="#">View Project</a><a className="font-bold font-inter underline dark:text-[#CBF281]" href="https://github.com/anilteoman/WiTFlix">Github</a>
